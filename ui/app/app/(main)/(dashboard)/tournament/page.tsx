...
const Tournament: React.FC<unknown> = () => {
	return (
		<div className="mx-auto max-w-[1000px] my-[40px]">
			<Tabs.Root defaultValue="live">
				...
				<Tabs.Content value="live">
					...
					<div className="mt-[60px]">
						...
						<Text as="div" size="3" mb="2" className="text-dark-200 p-6 rounded-br-md rounded-bl-md bg-dark-700 mb-8 shadow-xl">
							To get started, Head to the <strong className="text-accent-200/90">Browse</strong> tab to find and register for
							a tournament. Please choose carefully, as{' '}
							<strong className="text-accent-200/90">registration is final and cannot be undone</strong>. Once the tournament
							begins, you will be notified of your next match. Be ready, as you must{' '}
				...
				<Tabs.Content value="host">
					...
					<div className="mt-[60px]">
						...
						<Text as="div" size="3" mb="2" className="text-dark-200 p-6 rounded-br-md rounded-bl-md bg-dark-700 mb-8 shadow-xl">
							You can host your own tournament by choosing a name (3 to 20 letters, no spetial symbols), a size (4, 8, or 16 players), and an alias you will compete
							under. As the host, you are <strong className="text-accent-200/90">automatically registered to play</strong>.
							Please note that you can only run <strong className="text-accent-200/90">one tournament at a time</strong>, and
							it will be <strong className="text-accent-200/90">automatically canceled</strong> if all player slots are not
							filled within 15 minutes of its creation.
						</Text>
					</div>
				</Tabs.Content>
