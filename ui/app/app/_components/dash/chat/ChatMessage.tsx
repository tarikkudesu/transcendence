		...
		<div className="flex justify-between m-4">
			...
			<div className="max-w-[70%]">
				<div className="flex justify-between">
					<div className=""></div>
					<div className="text-sm py-2 px-4 text-black rounded-t-[12px] rounded-br-[4px] rounded-bl-[12px] bg-accent-500 break-all">
						{data.message}
					</div>
				</div>
	...
	return (
		<div className="flex justify-between m-4">
			<div className="flex justify-start items-end gap-2">
				...
				<div className="w-[70%]">
					<div className="flex justify-between">
						<div className="text-sm py-2 px-4 rounded-t-[12px] rounded-bl-[4px] rounded-br-[12px] bg-accent-900/80 text-white break-all">
							{data.message}
						</div>
					</div>
