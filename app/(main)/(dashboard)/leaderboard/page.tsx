...
const LeaderBoard: React.FC<unknown> = () => {
	return (
		<div className="mx-auto max-w-[1400px] relative">
			<div className="p-4 rounded-md bg-dark-700 my-8 shadow-xl">
			...
			<div className="p-4 rounded-md bg-dark-700 my-8 shadow-xl">
				<Flex justify="between" align="center" gap="4" mb="4">
					<div className="flex mb-1 mt-6">
						...
						<Text as="div" size="5" weight="bold">
							Doom Cards Leader Board
						</Text>
					</div>
					<Tooltip content="See All">
						<Link href="/doomleaderboard/0">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 640 640"
								height={24}
