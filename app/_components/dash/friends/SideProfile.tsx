'use client';
import { useGET, useMutate } from '@/app/_service/useFetcher';
...
import { ChallangeDoom, ChallangePong } from '../game/Buttons';
import useFriendshipCheck from './useFriendshipCheck';
import { AddButton, ChatButton } from './Buttons';
